...
- The trust anchor (`homelab-spire`) — created in Phase 4 of [Platform Engineering: Workload Identity](../../docs/platform-engineering-workload-identity.md); cluster-wide and permanent
